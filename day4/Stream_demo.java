...
class LocalStudent {
	...
	public LocalStudent(String name, int age, com.org.genp.day4.Location location,
...
class Student_Part{
	...
	public Student_Part(String name, int age, com.org.genp.day4.Location location,
			List<PhoneNumber> phoneNumbers) {
		super();
		this.name = name;
		this.age = age;
...
public class Stream_demo {
	...
	public static void main(String[] args) {
		...
		list_stud.add(new Student_Part("Ashish", 24, lc1, list1));
		...
		LocalStudent l_student1 = new LocalStudent("Ashish", 20, new Location("0873"), Arrays.asList(new PhoneNumber("76328"), new PhoneNumber("34342")));
		LocalStudent l_student2 = new LocalStudent("Krishna", 22, new Location("5126"), Arrays.asList(new PhoneNumber("32047"), new PhoneNumber("8739")));
		LocalStudent l_student3 = new LocalStudent("Sohan", 29, new Location("8123"), Arrays.asList(new PhoneNumber("09347"), new PhoneNumber("9730")));
